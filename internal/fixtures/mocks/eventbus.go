...
func (_mock *MockEventBus) Publish(ctx context.Context, event domain.Event) error {
...
func (_c *MockEventBus_Publish_Call) Run(run func(ctx context.Context, event domain.Event)) *MockEventBus_Publish_Call {
...
func (_c *MockEventBus_Publish_Call) RunAndReturn(run func(ctx context.Context, event domain.Event) error) *MockEventBus_Publish_Call {
	_c.Call.Return(run)
	return _c
}

// Subscribe provides a mock function for the type MockEventBus
func (_mock *MockEventBus) Subscribe(eventType string, handler func(context.Context, domain.Event)) {
...
func (_c *MockEventBus_Subscribe_Call) Run(run func(eventType string, handler func(context.Context, domain.Event))) *MockEventBus_Subscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
		}
		var arg1 func(context.Context, domain.Event)
		if args[1] != nil {
			arg1 = args[1].(func(context.Context, domain.Event))
		}
		run(
			arg0,
			arg1,
...
func (_c *MockEventBus_Subscribe_Call) RunAndReturn(run func(eventType string, handler func(context.Context, domain.Event))) *MockEventBus_Subscribe_Call {
	_c.Run(run)
	return _c
}
