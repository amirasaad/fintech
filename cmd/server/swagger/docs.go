...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.AccountRead"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/account.AggregatedBalanceResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.InitiateOnboardingResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.OnboardingStatusResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        "account.AggregatedBalanceResponse": {
            "type": "object",
            "properties": {
                "totals": {
                    "type": "object",
        ...
        "dto.InitiateOnboardingResponse": {
            "type": "object",
            "properties": {
                "onboarding_url": {
                    "description": "OnboardingURL is the URL to redirect the user to for Stripe Connect onboarding",
                    "type": "string"
                }
            }
        },
        "dto.OnboardingStatusResponse": {
            ...
            "properties": {
                "is_complete": {
                    "description": "IsComplete indicates whether the user has completed Stripe Connect onboarding",
                    "type": "boolean"
                }
            }
        },
