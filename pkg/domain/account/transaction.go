...
const (
	// TransactionStatusPending indicates that a transaction has been initiated and is awaiting completion.
	TransactionStatusPending TransactionStatus = "pending"
	// TransactionStatusCompleted indicates that a transaction has been completed successfully.
	TransactionStatusCompleted TransactionStatus = "completed"
	// TransactionStatusFailed indicates that a transaction has failed.
...
// Transaction represents a financial transaction, capturing all details of a single ledger entry.
...
type Transaction struct {
	...
	CreatedAt      time.Time
	// TargetCurrency specifies the currency the account is credited in, which is crucial for multi-currency deposits.
	TargetCurrency string
	// ConversionInfo holds details about any currency conversion that occurred during the transaction.
...
// or for setting up test fixtures. It bypasses domain invariants and should not be used in business logic.
